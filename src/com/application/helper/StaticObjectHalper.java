...
public class StaticObjectHalper {
	...
	public static List<BeachModel> createStaticBeachList(){
		...
		BeachModel palmahim = getBeachModel("111","פלמחי�?",4,"http://i.imgur.com/DvpvklR.png",100,10,"חוף פלמחי�? - קיבוץ פלמחי�? חוף טיבעי לל�? מסעדות מיוחדות. קיימת מסעדה �?חת כניסה",400,300,15);
		BeachModel reshon = getBeachModel("112","חוף ר�?שון",4,"http://i.imgur.com/DvpvklR.png",300,22,"חוף פלמחי�? - קיבוץ פלמחי�? חוף טיבעי לל�? מסעדות מיוחדות. קיימת מסעדה �?חת כניסה",430,60,15);
		BeachModel gordon = getBeachModel("113","פלמחי�?",4,"http://images.applicaster.com/accounts/32/broadcasters/1/vod_items/2163581/image_assets/3563203/original.jpg?1405656157",150,97,"חוף פלמחי�? - קיבוץ פלמחי�? חוף טיבעי לל�? מסעדות מיוחדות. קיימת מסעדה �?חת כניסה",100,620,0);
