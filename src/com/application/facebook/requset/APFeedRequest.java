...
public class APFeedRequest {	
	...
	public static final String POSTS_FIELDS = ",id,caption,message,link,object_id,type,source,picture,likes.limit(1).summary(true),comments.summary(true)";
	public static final String USERS_FIELDS = "{id,name,picture.type(large)}";
	public static final String COMMENTS_FIELDS = "{created_time,like_count,message,id,from" + USERS_FIELDS +"}";
